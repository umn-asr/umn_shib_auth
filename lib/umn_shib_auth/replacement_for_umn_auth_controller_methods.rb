module UmnShibAuth
  module ReplacementForUmnAuthControllerMethods
    ...
    def login_and_redirect_url(redirect_url=nil); shib_login_and_redirect_url(redirect_url); end
    def logout_and_redirect_url(redirect_url=nil); shib_logout_and_redirect_url(redirect_url); end
